"""
Django settings for hotel_compras project.
...
SECRET_KEY = 'django-insecure-k$z6f8177^kt8zs&y!!+uo_z5a$a4kg)_528vvxwz+g4^f1-bi'
...
WSGI_APPLICATION = 'hotel_compras.wsgi.application'
